package com.after.life.chatai.utils;
...
public class RedisUtil {
    ...
    public static Set<String> listKeysWithPrefix(String prefix) {
    ...
    /**
     * redis setnx with expire
     * @param key
     * @param value
     * @param sec
     * @return
     */
    public static boolean setNX(String key, Object value, long sec) {
        return Boolean.TRUE.equals(redisTemplate.opsForValue().setIfAbsent(key, value, sec, TimeUnit.SECONDS));
    }
